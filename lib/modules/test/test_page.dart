...
class _StatePractice extends State<TestPage> {
  final question = [
  ...
  void nextPage() async {
    if (currentIndex == question.length - 1) {
      Get.off(TestReport(widget.chapterName));
    } else {
      setAnimatedProgressValue();
  ...
  setAnimatedProgressValue() {
    setState(() {
      animatedProgressValue = (currentIndex + 1) / question.length;
    });
  }
}
